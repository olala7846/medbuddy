...
- Run every AI code review and final AI verification in dedicated subagent sessions that are independent of the implementer session. The implementer may fill either role only when a human explicitly requests or approves the exception; human review and verification remain unrestricted.
