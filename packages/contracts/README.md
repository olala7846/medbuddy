...
- Domains: auth, chat, workspace family map, dynamic memory with canonical message/source-sequence freshness fences, capture, care-record, handoff, grounding, persistence, demo
- Passive memory: exact effective human evidence, structured proposals, leased jobs, fences, and cursor ports
