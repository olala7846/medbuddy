...
| [proposals/DEEPSEEK_MODEL_SWAP_FACTCHECK.md](./proposals/DEEPSEEK_MODEL_SWAP_FACTCHECK.md) | Corrected Traditional-Chinese conclusion, production-swap blockers, and the fictional DeepSeek V4 evaluation gate |
