...
| LLM provider | Vertex AI `gemini-2.5-flash` | One approved multimodal provider; no runtime fallback. |
...
3. Confirm `gemini-2.5-flash` availability through the global endpoint.
